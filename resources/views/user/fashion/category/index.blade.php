                ...
                <div class="container">
                    ...
                    <div class="mb-30 hidden-sm" id="fashion-search-wrapper">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-5 col-5">
                                <div>
                                    <nav class="navbar navbar-default" role="navigation" id="fashion-navbar">
                                        ...
                                        <div class="collapse navbar-collapse categories-desktop" id="navbar-collapse-x">
                                            <ul class="nav navbar-nav navbar-right">
                                                @foreach ($categories as $cat)
                                                    <div class="btn-group dropright mt-3">
                                                        ...
                                                        <div class="dropdown-menu {{ $cat->slug }}">
                                                            <div class="row">
                                                                @foreach ($cat->childrenCategories as $subcategory)
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            @foreach ($subcategory->categories as $subcategoryVariant)
                                                                                <a class="dropdown-item"
                                                                                   href="{{ route('fashion.category.show', ['categorySlug' => $subcategory->slug, 'subcategorySlug' => $subcategoryVariant->slug]) }}"
                                                                                >
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-7 col-7" id="fashion-search">
                                <div class="row">
                                    <div class="col-lg-9 col-md-9" id="input-row">
                                        ...
                                        @foreach ($category->childrenCategories as $cat)
                                            <div>
                                                @if ($cat->categories->isNotEmpty())
                                                    <a href="{{ route('fashion.category.index', $cat) }}">
                                                        <i class="fa fa-angle-right mr-2"></i>
                                                        {{ $cat->name }}
                                                    </a>
                                                @else
                                                    <a href="{{ route('fashion.category.show', ['categorySlug' => $category->slug, 'subcategorySlug' => $cat->slug]) }}">
                                                        <i class="fa fa-angle-right mr-2"></i>
                                                        {{ $cat->name }}
                                                    </a>
                                                @endif
