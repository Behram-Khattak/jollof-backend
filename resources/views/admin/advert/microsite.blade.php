...
@if ($banners->isEmpty())
    ...
    <p class="text-center">No advert added yet</p>
    @can('create-banners')
    <div class="text-center"><a href="{{ url('admin/advert/create/'.request()->segment(4)) }}" class="btn btn-primary"><i class="la la-plus"></i> New Advert</a></div>
    @endcan
@else
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                {{ request()->segment(4) }} Advert
                            </h3>
                        </div>
                        <div class="kt-portlet__head-toolbar">
                            <a class="btn btn-primary" href="{{ url('admin/advert/create/'.request()->segment(4)) }}" role="button"><i class="la la-plus"></i> New Advert</a>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        <div class="bg-info text-white rounded p-3 mb-5">
                            <h4>INFORMATION</h4>
                            <p>Only one advert per slot can display at a time. Any advert you want to display would be the active advert. You can add multiple images to the advert. Only one active popup show at a time with multiple images on the advert.</p>
                        </div>
                        <div
                            ...
                            >
                              ...
                              <tbody>
                                  ...
                                  <tr role="row" class="odd">
                                    <td><a href="{{ url('admin/advert/'.$banner->id) }}"> {{ $banner->title }}</a></td>
                                    ...
                                    <td nowrap="">
                                        @can('update-banners')
                                        <a class="dropdown-item" href="{{ url('admin/advert/edit/'.$banner->id) }}"><i class="fa fa-pen"></i> Edit</a>
                                        @endcan
                                        @can('delete-banners')
