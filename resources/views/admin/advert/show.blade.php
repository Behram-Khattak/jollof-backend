                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <a class="btn btn-primary mr-3" href="/admin/advert/edit/{{ $banner->id }}" role="button"><i class="la la-edit"></i> Edit Advert</a>
                            <a class="btn btn-danger" href="#" data-toggle="modal" data-target=".delete-modal-sm" onclick="document.getElementById('delete-form').action = '/admin/advert/{{ $banner->id }}'"><i class="la la-trash"></i> Delete Advert</a>
                        </div>
                    </div>
                        ...
                        <table class="kt-datatable" id="roles-table" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" data-toggle="modal" data-target=".delete-modal-sm" onclick="document.getElementById('delete-form').action = '/admin/advert/ad/{{ $banner->id }}/{{ $loop->index }}'" class="btn btn-sm btn-icon btn-icon-md btn-outline-hover-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                @endforeach
