    ...
    <div class="kt-portlet">
        ...
        <div class="kt-portlet__body">
            <ul class="kt-nav kt-nav--bolder kt-nav--fit-ver kt-nav--v4" role="tablist">
                <li class="kt-nav__item {{ request()->routeIs('merchant.profile.show') ? 'active' : '' }}">
                    <a class="kt-nav__link" href="{{ route('merchant.profile.show') }}" role="tab">
                ...
                <li class="kt-nav__item">
                    <a class="kt-nav__link"
                       ...
                       role="tab"
                    >
                        <span class="kt-nav__link-icon"><i class="flaticon-photo-camera"></i></span>
                        <span class="kt-nav__link-text">Upload Profile Photo</span>
                    </a>
                </li>
            </ul>
        </div>
