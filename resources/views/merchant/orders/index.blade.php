                            ...
                            <table class="table" role="grid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('merchant.restaurant.order.details', ['code'=>$item->order->order_code]) }}">{{ $item->order->order_code }}</a>
                                            <p>
                                                @if ($item->preorder)
                                        ...
                                        <td>
                                            @if ($item->preorder)
                                            <span class="badge bg-white border border-primary">{{ date('d-M-Y, h:i a', strtotime($item->delivery_on)) }}</span><br>
...
<div class="modal fade process-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="{{ route('merchant.restaurant.order.update') }}" method="POST" class="delete-form">
                <div class="modal-body">
                    <div class="delivered">
                    ...
                    <div class="contentx">
                        <div class="processed">
                            ...
                            <p>Are you sure you want to continue with this order process?</p>
                            <label for="exampleInputPassword1">How long will this take?</label>
                            <select name="duration_process" class="form-control">
                                <option value="15">15 Mins</option>
                                <option value="30">30 Mins</option>
                                <option value="45">45 Mins</option>
                                <option value="60">60 Mins</option>
                        ...
                        <div class="picked">
                            ...
                            <select name="duration_picked" class="form-control">
                                <option value="20">15 Mins</option>
                                <option value="30">30 Mins</option>
                                <option value="45">45 Mins</option>
                                <option value="60">60 Mins</option>
                                <option value="75">75 Mins</option>
