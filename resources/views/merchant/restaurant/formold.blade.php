...
<div class="form-group">
    ...
    <input type="text" name="min_order" class="form-control" value="{{ old('min_order') ? old('min_order') : $restaurant->min_order }}" placeholder="Minimum Order">
    @error("min_order") <small style="color: red;"> {{ $message }} </small> @enderror
</div>

<div class="form-group">
    <label for="example-readonly">Delivery Fee(NGN)</label>
    <input type="text" name="delivery_fee" class="form-control" value="{{ old('delivery_fee') ? old('delivery_fee') : $restaurant->delivery_fee }}" placeholder="Delivery Fee">
...
<div class="form-group">
    ...
    <input type="text" name="delivery_time" class="form-control" value="{{ old('delivery_time') ? old('delivery_time') : $restaurant->delivery_time }}" placeholder="Delivery Time">
...
<div class="form-group">
    ...
    <input type="text" name="disposable" class="form-control" value="{{ old('disposable') ? old('disposable') : $restaurant->disposable }}" placeholder="Plastic/Disposable pack">
