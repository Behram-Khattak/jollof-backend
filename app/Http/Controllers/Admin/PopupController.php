...
class PopupController extends Controller
{
    ...
    public function microsite($site)
    {
        ...
        $banners = Banner::where('microsite', $site)->where('banner_type', 'popup')->get();

        return view('admin.popup.microsite', compact(['location', 'banners']));
    }
    ...
    public function create()
    {
        ...
        return view('admin.popup.create', compact(['banner', 'microsite', 'slots', 'duration']));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect("/admin/popup/p/{$microsite}")->with([
    ...
    public function show($id)
    {
        ...
        return view('admin.popup.show', compact(['banner']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.popup.edit', compact(['banner', 'banner_type', 'location', 'duration']));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect("/admin/popup/{$id}")->with([
    ...
    public function destroy($id)
    {
        ...
        if ($banner == null) {
            ...
            redirect("/admin/popup/{$id}")->with([
                'message'    => 'There was a problem deleting the PopUp!',
                'alert-type' => 'error',
            ]);
        }
        $microsite = $banner->microsite;
     ...
     * @return type
     */
    public function destroy_popup($id, $index)
    {
        $banner = Banner::findorfail($id);
